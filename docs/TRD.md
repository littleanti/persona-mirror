...
> 문서 버전: 2.3 · 갱신일: 2026-09-05 · 상태: P11 최종 — 코드 최종 상태와 대조 완료. 기준: [PRD 1.6](./PRD.md) / [PLAN 2.5](./PLAN.md) / [DESIGN 1.7](./DESIGN.md)
